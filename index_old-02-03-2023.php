...
<head>
    <meta charset="UTF-8">
    <title>КЛЮЧАВТО Chery Ростов</title>
    ...
    <header class="header">
        <div class="container header-container in-view" has-animation="">
            <div class="header__item logo-block" js-popup data-title="Заполнить заявку<br> на обратную связь">
                ...
                <img class="logo-block__brand" src="static/img/logos/logo.png" alt="">
        ...
        <div class="section section-model" >
            <div class="container" id="models">
                ...
                <div class="car-list" id="car-list">
                    ...
                    <div class="car-list__item" data-brand="<?= $car['model'] ?>">
                        ...
                        <div class="car-content">
                            ...
                            <div class="car-content__wrap">
                                ...
                                <div class="btn-block">
                                    ...
                                    <?php else: ?>
                                        <button class="btn btn-model btn-model--02" js-popup data-title="Привлекательные условия!">
                                            Привлекательные условия!
                                        </button>
                                    <?php endif; ?>
                                    <button class="btn btn-model btn-model--03" js-popup data-title="Получить предложение">
                                            Получить предложение
                                    </button>
        ...
        <div class="section section-credit" id="credit">
            <div class="container">
                <div class="credit-block">
                    <h3 class="credit-block__title">КРЕДИТ ОТ 7,9%</h3>
                    <p class="credit-block__subtitle">Оставьте заявку на кредит</p>
